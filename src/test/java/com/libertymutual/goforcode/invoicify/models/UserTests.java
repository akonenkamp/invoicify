...
public class UserTests {
	...
	@Test
	public void test_that_isCredentialNonExpired_returns_true() {
		User user = new User();
		boolean nonCredentialExpired = user.isCredentialsNonExpired();
		assertThat(nonCredentialExpired).isTrue();
	}
